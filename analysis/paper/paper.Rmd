...
Aim of the following code chunk: We subsetted a larger data frame for just the middle-hall buildings. Calculations later showed we need the data frame of middle-hall buildings without the stone cone building as well.
...
1. for all middle-hall buildings:
...
```{r analyse residuals of lin. regression of all middle-hall buildings}
# following the hints of https://www.r-bloggers.com/visualising-residuals/

# 1. all middle-hall buildings
...
2. for the middle-hall buildings without the stone-cone building
...
```{r residual analysis of linear regression for middle hall buildings without the stone cone building}
